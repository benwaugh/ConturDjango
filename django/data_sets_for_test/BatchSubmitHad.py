...
HerwigSetup="source /unix/cedar/software/sl6/Herwig-Tip/setupEnv.sh"
ConturSetup="source /home/npart/bitbucket/conturtest/setupContur.sh"

for i in range(100,3100,500):
    for j in range(100,2100,500):
